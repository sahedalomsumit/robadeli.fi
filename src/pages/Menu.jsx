...
const menuItems = [
  // Subs
  {
    ...
    price: '9.90',
    image: '/images/grilled-chicken-sub.png',
    tag: 'popular',
  },
  {
    id: 2,
    ...
    price: '11.50',
    image: '/images/philly-cheese-steak.png',
    tag: 'popular',
  },
  {
    id: 3,
    ...
    price: '10.50',
    image: '/images/ultimate-italian-sub.png',
  },
  {
    id: 4,
    category: 'subs',
  ...
  },
  {
    ...
    price: '13.50',
    image: '/images/beef-brisket-sub.png',
  },
  {
    id: 6,
    category: 'subs',
  ...
  },
  {
    ...
    price: '9.50',
    image: '/images/cheese-melt-sub.png',
  },
  // Salads
  {
    id: 8,
    ...
    price: '10.50',
    image: '/images/falafel-salad.png',
    tag: 'vegan',
  },
  {
    id: 9,
  ...
  // Smoothies
  {
    ...
    price: '7.50',
    image: '/images/fresh-fruit-smoothies.png',
    tag: 'vegan',
  },
  // Wraps
  {
    ...
    <main className="menu-page page-enter" id="main-content">
      ...
      <m.section {...fadeInUp} className="menu-hero" aria-label="Menu hero" id="menu-hero">
        <div className="menu-hero-bg">
          <img src="/images/italian-sub-sandwich.png" alt="" aria-hidden="true" />
          <div className="menu-hero-overlay"></div>
        </div>
        <div className="container menu-hero-content">
          <img src="/images/robadeli-logo.png" alt="Roba Deli" className="menu-hero-logo" />
        ...
        <div className="container">
          ...
          <div className="physical-menu" id="physical-menu">
            ...
            <div className="physical-menu-grid">
              {['/images/robadeli-menu-page-1.jpg', '/images/robadeli-menu-page-2.jpg', '/images/robadeli-menu-page-3.jpg'].map((src, idx) => (
                <img
                  key={idx}
                  src={src}
